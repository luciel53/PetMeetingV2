	...
	return (
	  <main className="container flex flex-col mt-20 lg:w-[96rem] mx-auto">
		...
		<section className="flex flex-wrap md:flex-row justify-between">
		  ...
		  {/* Welcome bubble */}
		  <div className="w-64 md:w-[40%] mr-8 lg:mr-36 lg:h-[60%] mt-0 md:mt-4 lg:mt-8 p-8 bg-white shadow-lg rounded-3xl lg:rounded-full text-center">
			<div className="relative hidden lg:block lg:left-0 lg:top-52 lg:w-6 lg:h-5 bg-white shadow-sm"></div>
